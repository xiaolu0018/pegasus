...
func GenPersonJpgPic(path, name, company, pic_person, pic_declaration string) ( string,  error) {
	...
	person_gpeg, err := jpeg.Decode(personFile)
	if err != nil {
		return "", err
	}
	...
	personWidth := person_gpeg.Bounds().Size()
