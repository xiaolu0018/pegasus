...
curl -v -XPOST ${target}/api/appointment -d '{"appointor":"潘新元","cardtype":"身份证", "cardno":"210221198906068111", "mobile":"17777777777", "merrystatus":"未婚", "org_code":"0001001001", "appoint_channel":"微信"}'
